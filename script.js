...
{type:"fill",q:"   احدى طرق الاستفادة من الموارد الطبيعية يسمى  ",correct:"الاستخدام الستدام"}
],
...
{type:"mcq",q:"    في تجربة الكشف عن النترات في مصادر المياه، ما النتيجة المتوقعة لارتفاع مستوى النترات بشكل كبير ",options:[" تحول الماء إلى ماء مقطر نقي تلقائياً"," زيادة معدل نمو الطحالب في مجاري المياه  "," زيادة معدل نمو الطحالب في مجاري المياه "],correct:1},
